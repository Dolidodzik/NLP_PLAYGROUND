...
train_texts, train_labels = load_data('DATASETS/DATASET_100MB/TRAINING_DATASET.csv')
val_texts, val_labels = load_data('DATASETS/DATASET_100MB/VALIDATION_DATASET.csv')
...
train_loader, val_loader = create_data_loaders(tokenizer, BATCH_SIZE)
